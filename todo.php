...
<body>
    <div class="container p-3 ">
        <form action="" class="border">
            ...
            <div class="form-group px-5">
                <button class=" form-control btn btn-lg btn-primary" type="button">Submit</button>
            </div>
        </form>
    </div>
    ...
    <div class="d-flex flex-row">
        ...
        <div class="card text-white bg-dark m-3 " style="max-width: 20rem;">
            <div class="card-header"><?php echo $value['date']; ?>
                <a href="updateToDo.php?id=<?php echo $value['id']; ?>" class="btn btn-warning float-right">
