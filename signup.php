...
<body>
    <div class="d-flex flex-row">
        <div class="p-2" style="flex:2;">
            <h2 class="">Student Details Table</h2>
            <table class="table table-hover">
                ...
                <tbody>
                    <?php foreach($std_details as $key=>$value): //var_dump($value);   ?>
                    <tr class="table-primary ">
                        <td><?php echo $value['std_id']; ?></td>
                        <td><?php echo $value['std_name']; ?></td>
                        <td><?php echo $value['std_email']; ?></td>
                        <td><?php echo $value['std_dob']; ?></td>
                        <td><?php echo $value['std_country']; ?></td>
                        <td><?php echo $value['std_gender']; ?></td>
                        <td>
        ...
        <div class="p-2" style="flex:1; border-left: 3px solid #000;">
            <form action="">
                <h2>Sign Up Form</h2>

                <!-- <div class="alert alert-dismissible alert-danger form-group my-0">
                    <strong>Oh snap! and try
                        submitting again.</strong>
                </div> -->
                ...
                <div class="form-group">
                    <label for="exampleSelect1" class="form-label mt-4">Country</label>
                ...
                <div class="form-group">
                    <button class=" form-control btn btn-lg btn-primary" type="button">Sign Up</button>
                </div>
            </form>
        </div>
    </div>
